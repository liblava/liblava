...
cpmaddpackage(NAME spdlog GITHUB_REPOSITORY ${spdlog_GITHUB} GIT_TAG
              ${spdlog_TAG})
...
cpmaddpackage(
  ...
  GITHUB_REPOSITORY
  ${VulkanMemoryAllocator_GITHUB}
  GIT_TAG
  ${VulkanMemoryAllocator_TAG}
  DOWNLOAD_ONLY
  YES)
...
cpmaddpackage(
  ...
  IconFontCppHeaders
  GITHUB_REPOSITORY
  ${IconFontCppHeaders_GITHUB}
  GIT_TAG
  ${IconFontCppHeaders_TAG}
  DOWNLOAD_ONLY
  YES)
...
if(LIBLAVA_TEST)
  cpmaddpackage(NAME Catch2 GITHUB_REPOSITORY ${Catch2_GITHUB} GIT_TAG
                ${Catch2_TAG})
endif()
