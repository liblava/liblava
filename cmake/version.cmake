...
set(argh_TAG 431bf323acd3bb805483491ff277dac5d85772ad)

set(glfw_GITHUB glfw/glfw)
set(glfw_TAG bf945f1213728a98f7647380616f9cff9f6b3611)

set(gli_GITHUB g-truc/gli)
set(gli_TAG 779b99ac6656e4d30c3b24e96e0136a59649a869)

set(glm_GITHUB g-truc/glm)
set(glm_TAG 4137519418a933e5863eea7c3ac53890ae7faf9d)

set(physfs_GITHUB icculus/physfs)
set(physfs_TAG 741c4be358cd87366af1387d1e04e3f7d4f50c1e)
...
set(Vulkan-Headers_TAG cfebfc96b2b0bce93da7d12f2c14cc01793ae25c)

set(volk_GITHUB zeux/volk)
set(volk_TAG c5dbc0a7b38786b4d81d4057088b29390dd320df)

set(VulkanMemoryAllocator_GITHUB GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator)
set(VulkanMemoryAllocator_TAG 19b940e864bd3a5afb3c79e3c6788869d01a19eb)

set(IconFontCppHeaders_GITHUB juliettef/IconFontCppHeaders)
set(IconFontCppHeaders_TAG 8886c5657bac22b8fee34354871e3ade2a596433)

set(imgui_GITHUB ocornut/imgui)
set(imgui_TAG 868facff9ded2d61425c67deeba354eb24275bd1)

set(imgui_docking_GITHUB ocornut/imgui)
set(imgui_docking_TAG 085781f5ca5372d5fc804d7e44b5bf27a8994af7)

set(SPIRV-Headers_GITHUB KhronosGroup/SPIRV-Headers)
set(SPIRV-Headers_TAG 7d500c4d75ae3fbd37e1d5a20008ca9c8ee3c860)

set(SPIRV-Tools_GITHUB KhronosGroup/SPIRV-Tools)
set(SPIRV-Tools_TAG dda7731e91c130e64980d987a02f5c75356400cc)

set(glslang_GITHUB KhronosGroup/glslang)
set(glslang_TAG 3225778615fd9d7e23fd11b71a05097d59ba0247)

set(shaderc_GITHUB google/shaderc)
set(shaderc_TAG 9a658e242ad4d1a4b3491383c1c58c780e3c01ff)
...
set(Catch2_TAG bfe3ff8f19d3436381b4e3a18c13734d21a8b089)
